<template>
  <div class="mt-24 container mx-auto px-4">
    <div v-if="record && details"
         class="space-y-20">
      <!-- Owner warning -->
      <div v-if="!record.verification && details.is_owner && !details.show_secret"
    ...
    <div v-if="displayPoweredBy"
         class="text-center pt-20 text-xs text-gray-400 dark:text-gray-600">
